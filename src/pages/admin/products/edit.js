...
import { editSP, getSP } from "../../../api/product";
                  ...
                  <div class=" px-4 py-6 sm:px-0">
                      ...
                      <form id="formAddProduct">
                          ...
                          <div>
                              ...
                              <div class="mt-1">
                                  <input id="price-post" type="number" name="" rows="3"
                                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md h-7 pl-3" value="${data.price}"
                          ...
                          <div>
                              ...
                              <div class="mt-1">
                                  <input id="desc-post" name="" rows="3"
                                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md pl-3 h-10"
                                      placeholder="Mời nhập mô tả" value="${data.desc}">
                              </div>
                          </div>
