                                  ...
                                  <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                      <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-96">Description</th>
                                      </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            ${response.data.map((post, index) => /* html */`
                                                    ...
                                                    <td class="pl-8">${index + 1}</td>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap h-20 ">
                                                        <div style="white-space: normal;" class="w-full"> ${post.desc}</div>
                                                        
                                                        </td>
                                                        
                                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" >
                                                            <a href="/admin/product/${post.id}/edit"> <button class="btn-e bg-blue-500 text-white inline-block py-3 px-5 rounded w-20">Edit</button></a>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
