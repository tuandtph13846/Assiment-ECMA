...
(function ($) {
    ...
    $.fn.lightBox = function (settings) {
        ...
        function _resize_container_image_box(intImageWidth, intImageHeight) {
            ...
            $("#lightbox-container-image-box").animate({ width: intWidth, height: intHeight }, settings.containerResizeSpeed, () => { _show_image(); });
        ...
        function _finish() {
            ...
            $("#jquery-overlay").fadeOut(() => { $("#jquery-overlay").remove(); });
